...
//   node Critic-19 one-shot CDP client.mjs eval "<js>"          Runtime.evaluate (awaitPromise, returnByValue)
//   node Critic-19 one-shot CDP client.mjs key <Code>           trusted keyDown+keyUp
//   node Critic-19 one-shot CDP client.mjs hold <Code>          keyDown only
//   node Critic-19 one-shot CDP client.mjs up <Code>            keyUp only
//   node Critic-19 one-shot CDP client.mjs shot <path>          PNG screenshot
//   node Critic-19 one-shot CDP client.mjs conmon               dump collected console buffer
// A persistent listener process (c18-conmon.mjs) collects console lines
